...
function createNewInventory() {
    ...
    let existingCharacterId = model.characters.filter(existingCharacter => existingCharacter.userId === UserId);
    let characterCount = existingCharacterId.length
    let newInventory = { userId: UserId, characterId: characterCount-1, hasKey: false, keySelected: false, pet: null, money: 1000, items: [{name: 'healthpotion', count:10, symbol: '🧪'}, {name: 'rope', count:1, symbol: 'rope'},],  }
